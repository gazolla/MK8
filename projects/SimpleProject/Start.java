...
/**
 * Start — Boot runner for the SimpleProject producer/consumer demo.
 *
 * Launches the Kernel with no interceptors (pure event bus), starts Consumer
...
public class Start {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("=======================================================");
            System.out.println("       MK8 SimpleProject — Producer / Consumer          ");
            System.out.println("=======================================================\n");
